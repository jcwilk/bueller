Feature: bumping version
  ...
  Scenario: major version
    ...
    And 'existing-project.gemspec' contains '2.0.0'
  ...
  Scenario: minor version
    ...
    And 'existing-project.gemspec' contains '1.6.0'
  ...
  Scenario: patch version
    ...
    And 'existing-project.gemspec' contains '1.5.4'
  ...
  Scenario: arbitrary version
    ...
    And 'existing-project.gemspec' contains '3.7.1'
  ...
  Scenario: arbitrary version with a build version plaintext
    ...
    And 'existing-project.gemspec' contains '3.7.1.2'
