    ...
    class TestBuildGem < Test::Unit::TestCase
      ...
      build_command_context "build for bueller" do
        ...
        should "assign base_dir" do
          assert_same @base_dir, @bueller.base_dir
        end

        should "assign gemspec_helper" do
          assert_same @gemspec_helper, @bueller.gemspec_helper
        end

        should "return BuildGem" do
          assert_kind_of Bueller::Commands::BuildGem, @command
        end
      end
      ...
      def initialize_build_gem_environment(has_version = false)
        ...
        @version_helper = "Bueller::VersionHelper"
        ...
        @command = Bueller::Commands::BuildGem.new
