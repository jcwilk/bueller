    ...
    class TestReleaseToGithub < Test::Unit::TestCase
      ...
      context "clean_staging_area?" do
        ...
        should "be false if there added files" do
          ...
          command = Bueller::Commands::ReleaseToGithub.new :repo => repo
        ...
        should "be false if there are changed files" do
          ...
          command = Bueller::Commands::ReleaseToGithub.new
          command.repo = repo
      ...
      context "regenerate_gemspec!" do
        setup do
          ...
          @command                = Bueller::Commands::ReleaseToGithub.new :output => @output,
                                                                   :repo => @repo,
