...
class Bueller
  # Extend a Gem::Specification instance with this module to give it Bueller
  # super-cow powers.
  #
  ...
  module Specification
    ...
    # Assigns the Bueller defaults to the Gem::Specification
    def set_bueller_defaults(base_dir, git_base_dir = nil)
...
# documented in http://github.com/technicalpickles/bueller/issues#issue/73
